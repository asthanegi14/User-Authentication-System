        ...
        <div className={styles.glass}>
          ...
          <form className="py-1" onSubmit={formik.handleSubmit}>
            ...
            <div className="textbox flex flex-col items-center gap-6">
              ...
              <button className={styles.btn} type="submit">Start</button>
            </div>

            <div className="text-center py-4">
              {/* using Link instead of a tag so that it will redirect to register page without reloading  */}
              <span className="text-gray-500" >Don't have an account? <Link to="/register" className="text-red-500" >Register Now</Link> </span>
            </div>
          </form>
        </div>
      </div>
